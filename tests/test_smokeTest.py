...
class TestSmokeTest():
  ...
  def test_untitled(self):
    ...
    self.driver.find_element(By.NAME, "lname").send_keys("Aloya")
    self.driver.find_element(By.NAME, "bizname").click()
    self.driver.find_element(By.NAME, "bizname").send_keys("Freelance")
    self.driver.find_element(By.NAME, "biztitle").send_keys("Junior web developer")
    ...
    assert len(elements) > 0
    self.driver.find_element(By.ID, "username").send_keys("jalok")
    self.driver.find_element(By.ID, "password").click()
    self.driver.find_element(By.ID, "password").send_keys("199019")
